...
<body>
	...
	<div class="screen">
		<div class="screen__content">
			<form class="signup" id="form1" runat="server">
				<div class="signup__field">
					<i class="signup__icon fas fa-user"></i>
					<input type="text" class="signup__input" placeholder="Name" />
				</div>
				<div class="signup__field">
					<i class="signup__icon fas fa-at"></i>
				...
				<button class="button signup__submit" onclick="">
